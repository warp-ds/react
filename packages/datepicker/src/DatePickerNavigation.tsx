...
export const DatePickerNavigation = ({ phrases, nextMonth, prevMonth }: DatePickerNavigationProps) => {
  return (
    <div className="inline-flex">
      <Button small pill className="absolute left-16 top-12" aria-label={phrases.jumpToPrevMonth} onClick={prevMonth}>
        <IconChevronLeft16 />
      </Button>
      <Button small pill className="absolute right-16 top-12" aria-label={phrases.jumpToNextMonth} onClick={nextMonth}>
        <IconChevronRight16 />
      </Button>
    </div>
  );
