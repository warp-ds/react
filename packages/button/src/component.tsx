...
>((props, ref) => {
  ...
  const primaryClasses = [
    !small &&
      !quiet &&
      !loading &&
      (disabled ? ccButton.primaryDisabled : ccButton.primary),
    small &&
      !quiet &&
      !loading &&
      (disabled ? ccButton.primarySmallDisabled : ccButton.primarySmall),
    small &&
      quiet &&
      !loading &&
      (disabled
        ? ccButton.primarySmallQuietDisabled
    ...
    !small &&
      quiet &&
      !loading &&
      (disabled ? ccButton.primaryQuietDisabled : ccButton.primaryQuiet),
    !small &&
      loading &&
      (quiet ? ccButton.primaryQuietLoading : ccButton.primaryLoading),
  ];
  ...
  const secondaryClasses = [
    !small &&
      !quiet &&
      !loading &&
      (disabled ? ccButton.secondaryDisabled : ccButton.secondary),
    small &&
      !quiet &&
      !loading &&
      (disabled ? ccButton.secondarySmallDisabled : ccButton.secondarySmall),
    small &&
      quiet &&
      !loading &&
      (disabled
        ? ccButton.secondarySmallQuietDisabled
    ...
    !small &&
      quiet &&
      !loading &&
      (disabled ? ccButton.secondaryQuietDisabled : ccButton.secondaryQuiet),
    !small &&
      loading &&
      (quiet ? ccButton.secondaryQuietLoading : ccButton.secondaryLoading),
  ];
  ...
  const utilityClasses = [
    !small &&
      !quiet &&
      !loading &&
      (disabled ? ccButton.utilityDisabled : ccButton.utility),
    small &&
      !quiet &&
      !loading &&
      (disabled ? ccButton.utilitySmallDisabled : ccButton.utilitySmall),
    small &&
      quiet &&
      !loading &&
      (disabled
        ? ccButton.utilitySmallQuietDisabled
    ...
    !small &&
      quiet &&
      !loading &&
      (disabled ? ccButton.utilityQuietDisabled : ccButton.utilityQuiet),
    !small &&
      loading &&
      (quiet ? ccButton.utilityQuietLoading : ccButton.utilityLoading),
  ];
  ...
  const negativeClasses = [
    !small &&
      !quiet &&
      !loading &&
      (disabled ? ccButton.negativeDisabled : ccButton.negative),
    small &&
      !quiet &&
      !loading &&
      (disabled ? ccButton.negativeSmallDisabled : ccButton.negativeSmall),
    small &&
      quiet &&
      !loading &&
      (disabled
        ? ccButton.negativeSmallQuietDisabled
    ...
    !small &&
      quiet &&
      !loading &&
      (disabled ? ccButton.negativeQuietDisabled : ccButton.negativeQuiet),
    !small &&
      loading &&
      (quiet ? ccButton.negativeQuietLoading : ccButton.negativeLoading),
  ];
