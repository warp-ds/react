...
export function Toggle(props: ToggleProps) {
  ...
  const labelClasses = classNames([
    ...
    isRadioButton &&
      (props.small ? ccToggle.radioButtonsSmall : ccToggle.radioButtonsRegular),
    ...
    isCheckbox &&
      ...
      isInvalid &&
      !isDisabled &&
      ccToggle.checkboxInvalid,
    isCheckbox &&
      !isIndeterminate &&
      !isInvalid &&
      isDisabled &&
      ccToggle.checkboxDisabled,
    isCheckbox &&
      isIndeterminate &&
      !isInvalid &&
      !isDisabled &&
      ccToggle.indeterminate,
    isCheckbox &&
      isIndeterminate &&
      isInvalid &&
      !isDisabled &&
      ccToggle.indeterminateInvalid,
    isCheckbox &&
      isIndeterminate &&
      !isInvalid &&
      isDisabled &&
      ccToggle.indeterminateDisabled,
  ...
  const wrapperClasses = classNames(props.className, [
    ...
    isRadioButton &&
      (props.equalWidth
        ? ccToggle.wrapperRadioButtonsJustified
        : ccToggle.wrapperRadioButtons),
  ]);

  const groupClasses = classNames(
    ccToggle.radioButtonsGroup,
    props.equalWidth && ccToggle.radioButtonsGroupJustified
  );
  ...
  return (
    ...
    >
      {props.title && (
        <Title id={id} title={props.title} optional={props.optional} />
      )}
