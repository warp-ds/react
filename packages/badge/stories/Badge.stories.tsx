	...
	<div className="space-y-16 max-w-[400px]">
		<div className="relative border border-0 rounded-8 overflow-hidden h-96">
			<img
				...
				src="https://source.unsplash.com/random/400x96"
				aria-label="price badge example position top left"
			/>
		...
		<div className="relative border border-0 rounded-8 overflow-hidden h-96">
			<img
				className="w-full h-96 object-cover"
				src="https://source.unsplash.com/random/400x96"
				aria-label="price badge example position top right"
			/>
		...
		<div className="relative border border-0 rounded-8 overflow-hidden h-96">
			<img
				className="w-full h-96 object-cover"
				src="https://source.unsplash.com/random/400x96"
				aria-label="price badge example position bottom right"
			/>
		...
		<div className="relative border border-0 rounded-8 overflow-hidden h-96">
			<img
				className="w-full h-96 object-cover"
				src="https://source.unsplash.com/random/400x96"
				aria-label="price badge example position bottom left"
			/>
