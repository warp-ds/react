...
const PaginationContainer = React.forwardRef<HTMLElement, PaginationContainerProps>(({ children, className, currentPage, lastPage, 'aria-labelledby': ariaLabelledBy = 'pagination-heading', ...props }, ref) => {
