...
`;function b({min:e=0,max:t=100,step:n=1,value:u,values:s,disabled:f,onChange:i,onChangeAfter:k,"aria-label":v,"aria-labelledby":q,"aria-valuetext":Ve,keyboardStepFactor:Se=.04,showTooltip:Re=!1,markers:B=!1,markerCount:D=10}){const c=(s?"range":"standard")==="range",p=o.useMemo(()=>We(n,B,D,t,e),[]),F=()=>s?z(s,p):[e,w(u,p)],[l,H]=o.useState(()=>F()),[W,O]=o.useState(!1),U=o.useRef(null),C=o.useRef(null),h=o.useRef(null),g=o.useRef(null),L=o.useRef(0);o.useEffect(()=>{if(Ee(u,s,e,t),!(document.activeElement===h.current||document.activeElement===g.current)){const r=F();H(r),te(U,r,C,c,t,e,p),S({values:r,value:u},c,h,g)}},[s,u]),o.useEffect(()=>{S({values:s,value:u},c,h,g)},[h.current,g.current]),o.useEffect(()=>{!W&&k&&k(c?l:l[1])},[W,l]),o.useEffect(()=>{h.current&&h.current.setAttribute("value",l[0]),g.current&&g.current.setAttribute("value",l[1])},[l]);const X=o.useCallback((r,d)=>{const m={left:-1,right:1},x=t*Se,V=l[d]+m[r]*x,y=P(V,d,c,l,e,t,p,!0);S({values:y,value:V},c,h,g),Y(y,d)},[l]),Te=o.useCallback((r,d)=>{(r.key==="ArrowUp"||r.key==="ArrowDown")&&r.preventDefault(),O(!0),r.key==="ArrowLeft"&&X("left",d),r.key==="ArrowRight"&&X("right",d)},[X]),G=o.useCallback(r=>{if(setTimeout(()=>{O(!0)},1),!f&&r.target.nodeName!=="INPUT"){const d=r.touches?Fe(r):r.nativeEvent.offsetX,m=C.current.clientWidth,x=w(d/m*(t-e)+e,p),V=(l[0]+l[1])/2,y=x>w(V,p)?1:0,j=P(x,y,c,l,e,t,p);Y(j,y),S({values:j,value:j[1]},c,h,g)}},[s,u,l]),Y=o.useCallback((r,d)=>{var m,x;if(clearTimeout(L.current),c){const y=w(r[1]-r[0],p)/(t-e)*(((m=C.current)==null?void 0:m.clientWidth)||500),j=(t-e)/(((x=C.current)==null?void 0:x.clientWidth)||500);y<24&&(d==0?r[0]=r[1]-j*24:r[1]=r[0]+j*24,S({values:r,value:r[1]},c,h,g))}L.current=setTimeout(()=>{r=je(r,e,t),H(r),i&&i(c?[Math.round(r[0]),Math.round(r[1])]:Math.round(r[1]))},1),te(U,r,C,c,t,e,p)},[]),Ae=o.useCallback((r,d)=>{const m=P(+r.target.value,d,c,l,e,t,p);Y(m,d)},[l]),E=()=>{J()};function J(){O(!1)}const Q=o.useCallback((r,d)=>f?a.jsx("input",{type:"range",disabled:!0,value:l[r],min:e,max:t}):a.jsx("input",{ref:d,type:"range",step:p,min:e,max:t,onKeyDown:m=>Te(m,r),onKeyUp:J,onChange:m=>Ae(m,r),...qe({ariaLabel:v,ariaLabelledBy:q,ariaValueText:Ve})}),[l]),_e=o.useMemo(()=>D==="auto"&&typeof p=="number"?(t-e)/p+1:D,[]),Me=o.useCallback(()=>Array.from(Array(_e).keys()).map(r=>a.jsxs("div",{className:"marker",children:[a.jsx("div",{children:"|"}),a.jsx("div",{children:r})]},r)),[]),K=Re&&W;let Z=0,ee=0;return K&&([Z,ee]=Ie(F(),t,e)),a.jsxs(a.Fragment,{children:[a.jsx("style",{children:Ne}),a.jsxs("div",{className:"ccSlider.wrapper wrapper",onContextMenu:r=>r.preventDefault(),children:[a.jsxs("div",{className:"active-track",ref:U,children:[a.jsx(re,{display:K&&c,top:document.activeElement===h.current,transform:`translateY(-50px) translateX(calc(-50% + ${Z}px))`,children:l[0]}),a.jsx(re,{display:K,top:document.activeElement===g.current,transform:`translateY(-50px) translateX(calc(50% + ${ee}px))`,children:l[1]})]}),a.jsxs("div",{className:"input-wrapper",ref:C,onMouseDown:G,onTouchStart:G,onKeyUp:E,onMouseUp:E,onTouchEnd:E,onMouseOut:E,children:[Q(1,g),c&&Q(0,h),a.jsx("div",{className:"steps",children:B&&Me()})]})]})]})}const Ie=(e,t,n)=>{const u=-((e[0]-n)/(t-n)-.5)*24,s=-((e[1]-n)/(t-n)-.5)*24;return[u,s]};function qe({ariaLabel:e,ariaLabelledBy:t,ariaValueText:n}){return{"aria-label":e,"aria-labelledby":t,"aria-valuetext":n}}function $(e,t,n){return Math.min(Math.max(e,t),n)}function Ee(e,t,n,u){(e&&e<n||t&&t[0]<n)&&console.warn("Value too low."),(e&&e>u||t&&t[1]>u)&&console.warn("Value too high.")}function S({value:e,values:t},n,u,s){n?(u.current&&(u.current.value=t[0]),s.current&&(s.current.value=t[1])):s.current&&(s.current.value=e)}const P=(e,t=1,n,u,s,f,i,k=!1)=>{let v;return e=Math.round(e),n?t===1?v=[u[0],e]:v=[e,u[1]]:v=[s,e],k?je(z(v,i),s,f):z(v,i)},De=(e,t,n,u,s,f)=>{var q;let i=w(e[1]-e[0],f)/(u-s);const k=((q=t.current)==null?void 0:q.clientWidth)||500;(i<0||i>1)&&(console.warn("Values outside of range."),i=$(i,0,1));const v=n?(e[0]-s)/(u-s)*k:0;return`
    width: ${i*100+"%"};
...
}`,...(Ce=(ke=I.parameters)==null?void 0:ke.docs)==null?void 0:Ce.source}}};const Ke=["Regular","Regular2","Regular3","Regular4","Range","Disabled","ChangeAfter"];export{I as ChangeAfter,N as Disabled,M as Range,R as Regular,T as Regular2,A as Regular3,_ as Regular4,Ke as __namedExportsOrder,Ye as default};
