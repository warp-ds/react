...
`;function b({min:e=0,max:t=100,step:n=1,value:u,values:o,disabled:p,onChange:h,onChangeAfter:w,"aria-label":f,"aria-labelledby":C,"aria-valuetext":Ke,keyboardStepFactor:ze=.04,showTooltip:Le=!1,markers:te=!1,markerCount:Y=10,showInputs:$=!1}){const d=(o?"range":"standard")==="range",g=a.useMemo(()=>at(n,te,Y,t,e),[]),W=()=>o?ee(o,g):[e,V(u,g)],K=a.useCallback(s=>{var y;let i=V(s[1]-s[0],g)/(t-e);const l=((y=S.current)==null?void 0:y.clientWidth)||500;return i*l<24?(t-e)/l*24:0},[]),[c,re]=a.useState(()=>W()),[R,O]=a.useState(()=>W()),[z,L]=a.useState(!1),B=a.useRef(null),S=a.useRef(null),v=a.useRef(null),x=a.useRef(null),ne=a.useRef(null),se=a.useRef(null),ae=a.useRef(0),H=Le&&z;a.useEffect(()=>{if(rt(u,o,e,t),!(document.activeElement===v.current||document.activeElement===x.current)){const s=W();re(s),o?O(o):u&&O([0,u]),pe(B,s,S,d,t,e),T({values:o,value:u},d,v,x)}},[o,u]),a.useEffect(()=>{T({values:o,value:u},d,v,x)},[v.current,x.current]),a.useEffect(()=>{!z&&w&&w(d?c:c[1])},[z,c]),a.useEffect(()=>{v.current&&v.current.setAttribute("value",c[0]),x.current&&x.current.setAttribute("value",c[1])},[c]);const G=a.useCallback((s,i)=>{const l={left:-1,right:1},m=t*ze,y=c[i]+l[s]*m,k=Q(y,i,d,c,e,t,g,!0);T({values:k,value:y},d,v,x),j(k,i)},[c]),Be=a.useCallback((s,i)=>{["ArrowUp","ArrowDown"].includes(s.key)&&s.preventDefault(),["ArrowLeft","ArrowRight"].includes(s.key)&&(L(!0),s.key==="ArrowLeft"&&G("left",i),s.key==="ArrowRight"&&G("right",i))},[G]),oe=a.useCallback(s=>{if(L(!0),!p&&s.target.nodeName!=="INPUT"){const i=s.touches?st(s):s.nativeEvent.offsetX,l=S.current.clientWidth,m=V(i/l*(t-e)+e,g),y=(c[0]+c[1])/2,k=m>V(y,g)?1:0,X=Q(m,k,d,c,e,t,g);j(X,k),T({values:X,value:X[1]},d,v,x)}},[o,u,c]),j=a.useCallback((s,i,l=!0)=>{if(clearTimeout(ae.current),d){const m=K(s);m>0&&(i==0?s[0]=s[1]-m:s[1]=s[0]+m),T({values:s,value:s[1]},d,v,x)}ae.current=setTimeout(()=>{s=$e(s,e,t),re(s),$&&l&&O(s),h&&h(d?[Math.round(s[0]),Math.round(s[1])]:Math.round(s[1]))},1),pe(B,s,S,d,t,e)},[]),He=a.useCallback((s,i)=>{const l=Q(+s.target.value,i,d,c,e,t,g);j(l,i)},[c]),U=()=>{ue()},ue=()=>{L(!1)},ie=a.useCallback((s,i)=>p?r.jsx("input",{type:"range",disabled:!0,value:c[s],min:e,max:t}):r.jsx("input",{ref:i,type:"range",step:g,min:e,max:t,onKeyDown:l=>Be(l,s),onKeyUp:ue,onChange:l=>He(l,s),...tt({ariaLabel:f,ariaLabelledBy:C,ariaValueText:Ke})}),[c]),le=(s,i)=>{const l=+s.target.value,m=i==0?[l,R[1]]:[R[0],l];O(m);const y=K(m);if(i==0){const k=[l,c[1]];l>=e&&l<=c[1]-y&&j(k,i,!1)}else if(i==1){const k=[c[0],l];(d?l<=t&&l>=c[0]+y:l<=t)&&j(k,i,!1)}},J=a.useMemo(()=>Y==="auto"&&typeof g=="number"?(t-e)/g+1:Y,[]),Ge=a.useCallback(()=>Array.from(Array(J).keys()).map(s=>{let i="";if(J<15&&(i=(t-e)/(J-1)*s+e,t>100)){const l=t.toString().length-1,m=ut(i/10**l,1);i=m>0?m+"e"+l:0}return r.jsxs("div",{className:"marker",children:[r.jsx("div",{children:"|"}),r.jsx("div",{children:i})]},s)}),[]),[Je,Qe]=H?et(W(),t,e):[0,0],ce=$?ot(R,e,t,[ne,se],K):[!0,!0];return r.jsxs(r.Fragment,{children:[r.jsx("style",{children:Ze}),r.jsxs("div",{className:"ccSlider.wrapper wrapper",onContextMenu:s=>s.preventDefault(),children:[r.jsxs("div",{className:"active-track",ref:B,children:[r.jsx(me,{display:H&&d,top:document.activeElement===v.current,transform:`translateY(-50px) translateX(calc(-50% + ${Je}px))`,children:c[0]}),r.jsx(me,{display:H,top:document.activeElement===x.current,transform:`translateY(-50px) translateX(calc(50% + ${Qe}px))`,children:c[1]})]}),r.jsxs("div",{className:"input-wrapper",ref:S,onMouseDown:oe,onTouchStart:oe,onKeyUp:U,onMouseUp:U,onTouchEnd:U,onMouseOut:U,children:[d&&ie(0,v),ie(1,x),r.jsx("div",{className:"steps",children:te&&Ge()})]}),$&&r.jsxs("div",{className:`inputs ${d?"dual":""}`,children:[d&&r.jsx(de,{value:R[0].toString(),ref:ne,invalid:!ce[0],onChange:s=>le(s,0)}),r.jsx(de,{value:R[1].toString(),ref:se,invalid:!ce[1],onChange:s=>le(s,1)})]})]})]})}const et=(e,t,n)=>{const u=-((e[0]-n)/(t-n)-.5)*24,o=-((e[1]-n)/(t-n)-.5)*24;return[u,o]};function tt({ariaLabel:e,ariaLabelledBy:t,ariaValueText:n}){return{"aria-label":e,"aria-labelledby":t,"aria-valuetext":n}}function Z(e,t,n){return Math.min(Math.max(e,t),n)}function rt(e,t,n,u){(e&&e<n||t&&t[0]<n)&&console.warn("Value too low."),(e&&e>u||t&&t[1]>u)&&console.warn("Value too high.")}function T({value:e,values:t},n,u,o){n?(u.current&&(u.current.value=t[0]),o.current&&(o.current.value=t[1])):o.current&&(o.current.value=e)}const Q=(e,t=1,n,u,o,p,h,w=!1)=>{let f;return e=Math.round(e),n?t===1?f=[u[0],e]:f=[e,u[1]]:f=[o,e],w?$e(ee(f,h),o,p):ee(f,h)},nt=(e,t,n,u,o)=>{var f;let p=(e[1]-e[0])/(u-o);const h=((f=t.current)==null?void 0:f.clientWidth)||500;(p<0||p>1)&&(console.warn("Values outside of range."),p=Z(p,0,1));const w=n?(e[0]-o)/(u-o)*h:0;return`
    width: ${p*100+"%"};
    margin-left: ${w+"px"};`},pe=(e,t,n,u,o,p)=>{e.current&&(e.current.style.cssText=nt(t,n,u,o,p))},$e=(e,t,n)=>[Z(e[0],t,n),Z(e[1],t,n)],st=e=>{const t=e.target.getBoundingClientRect(),n=e.touches[0].clientX-t.left;return Math.round(n)},V=(e,t)=>t>1?Math.round(e/t)*t:e,ee=(e,t)=>[V(e[0],t),V(e[1],t)],at=(e,t,n,u,o)=>{let p=e;if(t){const h=n;p=typeof e=="number"?e:Math.round((u-o)/(h-1))}return p},me=e=>r.jsx("div",{className:"tooltip",style:{transform:e.transform,visibility:e.display?"visible":"hidden",zIndex:e.top?10:1},children:Math.round(e.children)});function ot([e,t],n,u,[o,p],h){let w=!0,f=!0;if((e<n||e>u)&&(w=!1),(t>u||t<n)&&(f=!1),document.activeElement===o.current){const C=h([e,t]);e+C>t&&(w=!1)}if(document.activeElement===p.current){const C=h([e,t]);t<e+C&&(f=!1)}return[w,f]}function ut(e,t){const n=10**t;return Math.round(e*n)/n}b.__docgenInfo={description:"",methods:[],displayName:"Slider",props:{value:{required:!1,tsType:{name:"number"},description:""},values:{required:!1,tsType:{name:"Array",elements:[{name:"number"}],raw:"number[]"},description:""},onChange:{required:!1,tsType:{name:"any"},description:""},onChangeAfter:{required:!1,tsType:{name:"any"},description:""},max:{required:!1,tsType:{name:"number"},description:`The greatest value in the range of permitted values
