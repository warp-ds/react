...
`;function g({min:e=0,max:t=100,step:s=1,value:u,values:o,disabled:p,onChange:v,onChangeAfter:y,"aria-label":h,"aria-labelledby":j,"aria-valuetext":tt,keyboardStepFactor:nt=.04,showTooltip:st=!1,markers:oe=!1,markerCount:B=10,showInputs:H=!1}){const d=(o?"range":"standard")==="range",x=a.useMemo(()=>ht(s,oe,B,t,e),[]),$=()=>o?ae(o,x):[e,C(u,x)],[l,ue]=a.useState(()=>$()),[T,K]=a.useState(()=>$()),[G,P]=a.useState(!1),J=a.useRef(null),R=a.useRef(null),b=a.useRef(null),w=a.useRef(null),ie=a.useRef(null),le=a.useRef(null),ce=a.useRef(0),Q=st&&G,Z=a.useCallback(r=>{var m;const i=((m=R.current)==null?void 0:m.clientWidth)||500;if(C(r[1]-r[0],x)/(t-e)*i<L){const k=(t-e)/i;return C(k*L,s)}else return 0},[R.current]);a.useEffect(()=>{if(pt(u,o,e,t),!(document.activeElement===b.current||document.activeElement===w.current)){const r=$();ue(r),o?K(o):u&&K([0,u]),ge(J,r,R,d,t,e),_({values:o,value:u},d,b,w)}},[o,u]),a.useEffect(()=>{_({values:o,value:u},d,b,w)},[b.current,w.current]),a.useEffect(()=>{!G&&y&&y(d?l:l[1])},[G,l]),a.useEffect(()=>{b.current&&b.current.setAttribute("value",l[0].toString()),w.current&&w.current.setAttribute("value",l[1].toString())},[l]);const ee=a.useCallback((r,i)=>{const c={left:-1,right:1},f=t*nt,m=l[i]+c[r]*f,k=se(m,i,d,l,e,t,x,!0);_({values:k,value:m},d,b,w),I(k,i)},[l]),rt=a.useCallback((r,i)=>{["ArrowUp","ArrowDown"].includes(r.key)&&r.preventDefault(),["ArrowLeft","ArrowRight"].includes(r.key)&&(P(!0),r.key==="ArrowLeft"&&ee("left",i),r.key==="ArrowRight"&&ee("right",i))},[ee]),de=a.useCallback(r=>{if(P(!0),!p&&r.target.nodeName!=="INPUT"){const i=r.touches?ft(r):r.nativeEvent.offsetX,c=R.current.clientWidth,f=C(i/c*(t-e)+e,x),m=(l[0]+l[1])/2,k=f>C(m,x)?1:0,S=se(f,k,d,l,e,t,x);I(S,k),_({values:S,value:S[1]},d,b,w)}},[o,u,l]),I=a.useCallback((r,i,c=!0)=>{if(clearTimeout(ce.current),d){const f=Z(r);f>0&&(i==0?r[0]=r[1]-f:r[1]=r[0]+f),_({values:r,value:r[1]},d,b,w)}ce.current=setTimeout(()=>{r=et(r,e,t),ue(r),H&&c&&K(r),v&&v(d?[V(r[0]),V(r[1])]:Math.round(r[1]))},1),ge(J,r,R,d,t,e)},[]),at=a.useCallback((r,i)=>{const c=se(+r.target.value,i,d,l,e,t,x);I(c,i)},[l]),z=()=>P(!1),pe=a.useCallback((r,i)=>p?n.jsx("input",{type:"range",disabled:!0,value:l[r],min:e,max:t}):n.jsx("input",{ref:i,type:"range",step:x,min:e,max:t,onKeyDown:c=>rt(c,r),onKeyUp:()=>P(!1),onChange:c=>at(c,r),...dt({ariaLabel:h,ariaLabelledBy:j,ariaValueText:tt})}),[l]),me=a.useCallback((r,i,c,f)=>{const m=+r.target.value,k=i==0?[m,f[1]]:[f[0],m];K(k);const S=Z(k);if(i==0){const ne=[m,c[1]];m>=e&&m<=c[1]-S&&I(ne,i,!1)}else if(i==1){const ne=[c[0],m];(d?m<=t&&m>=c[0]+S:m<=t)&&I(ne,i,!1)}},[]),te=a.useMemo(()=>B==="auto"&&typeof x=="number"?(t-e)/x+1:B,[]),ot=a.useCallback(()=>Array.from(Array(te).keys()).map(r=>{let i="";if(te<15&&(i=(t-e)/(te-1)*r+e,t>100)){const c=t.toString().length-1,f=V(i/10**c,1);i=f>0?f+"e"+c:0}return n.jsxs("div",{className:"marker",children:[n.jsx("div",{children:"|"}),n.jsx("div",{children:i})]},r)}),[]),[ut,it]=Q?ct($(),t,e):[0,0],fe=H?gt(T,e,t,[ie,le],Z):[!0,!0];return n.jsxs(n.Fragment,{children:[n.jsx("style",{children:lt}),n.jsxs("div",{className:"ccSlider.wrapper wrapper",onContextMenu:r=>r.preventDefault(),children:[n.jsxs("div",{className:"active-track",ref:J,children:[n.jsx(ve,{display:Q&&d,top:document.activeElement===b.current,transform:`translateY(-50px) translateX(calc(-50% + ${ut}px))`,children:l[0]}),n.jsx(ve,{display:Q,top:document.activeElement===w.current,transform:`translateY(-50px) translateX(calc(50% + ${it}px))`,children:l[1]})]}),n.jsxs("div",{className:"input-wrapper",ref:R,onMouseDown:de,onTouchStart:de,onKeyUp:z,onMouseUp:z,onTouchEnd:z,onMouseOut:z,children:[d&&pe(0,b),pe(1,w),n.jsx("div",{className:"steps",children:oe&&ot()})]}),H&&n.jsxs("div",{className:`inputs ${d?"dual":""}`,children:[d&&n.jsx(he,{value:T[0].toString(),ref:ie,invalid:!fe[0],onChange:r=>me(r,0,l,T)}),n.jsx(he,{value:T[1].toString(),ref:le,invalid:!fe[1],onChange:r=>me(r,1,l,T)})]})]})]})}const ct=(e,t,s)=>{const u=-((e[0]-s)/(t-s)-.5)*L,o=-((e[1]-s)/(t-s)-.5)*L;return[u,o]};function dt({ariaLabel:e,ariaLabelledBy:t,ariaValueText:s}){return{"aria-label":e,"aria-labelledby":t,"aria-valuetext":s}}function pt(e,t,s,u){(e&&e<s||t&&t[0]<s)&&console.warn("Value too low."),(e&&e>u||t&&t[1]>u)&&console.warn("Value too high.")}function _({value:e,values:t},s,u,o){s?(u.current&&(u.current.value=t[0]),o.current&&(o.current.value=t[1])):o.current&&(o.current.value=e)}const se=(e,t=1,s,u,o,p,v,y=!1)=>{let h;return e=Math.round(e),s?t===1?h=[u[0],e]:h=[e,u[1]]:h=[o,e],y?et(ae(h,v),o,p):ae(h,v)},mt=(e,t,s,u,o)=>{var h;let p=(e[1]-e[0])/(u-o);const v=((h=t.current)==null?void 0:h.clientWidth)||500;(p<0||p>1)&&(console.warn("Values outside of range."),p=re(p,0,1));const y=s?(e[0]-o)/(u-o)*v:0;return`
    width: ${p*100+"%"};
    margin-left: ${y+"px"};`},ge=(e,t,s,u,o,p)=>{e.current&&(e.current.style.cssText=mt(t,s,u,o,p))},ft=e=>{const t=e.target.getBoundingClientRect(),s=e.touches[0].clientX-t.left;return V(s)},C=(e,t)=>typeof t!="string"&&t>1?V(e/t)*t:e,ae=(e,t)=>[C(e[0],t),C(e[1],t)],ht=(e,t,s,u,o)=>{let p=e;if(t){const v=s;p=typeof e=="number"?e:V((u-o)/(v-1))}return p},ve=({transform:e,display:t,top:s,children:u})=>n.jsx("div",{className:"tooltip",style:{transform:e,visibility:t?"visible":"hidden",zIndex:s?10:1},children:u});function gt([e,t],s,u,[o,p],v){let y=!0,h=!0;if((e<s||e>u)&&(y=!1),(t>u||t<s)&&(h=!1),document.activeElement===o.current){const j=v([e,t]);e+j>t&&(y=!1)}if(document.activeElement===p.current){const j=v([e,t]);t<e+j&&(h=!1)}return[y,h]}g.__docgenInfo={description:"",methods:[],displayName:"Slider",props:{value:{required:!1,tsType:{name:"number"},description:""},values:{required:!1,tsType:{name:"Array",elements:[{name:"number"}],raw:"number[]"},description:""},onChange:{required:!1,tsType:{name:"any"},description:""},onChangeAfter:{required:!1,tsType:{name:"any"},description:""},max:{required:!1,tsType:{name:"number"},description:`The greatest value in the range of permitted values
