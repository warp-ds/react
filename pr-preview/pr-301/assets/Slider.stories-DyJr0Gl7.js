...
`;function b({min:e=0,max:t=100,step:n=1,value:u,values:o,disabled:f,onChange:d,onChangeAfter:w,"aria-label":h,"aria-labelledby":V,"aria-valuetext":Ke,keyboardStepFactor:ze=.04,showTooltip:Le=!1,markers:te=!1,markerCount:X=10,showInputs:Y=!1}){const p=(o?"range":"standard")==="range",g=a.useMemo(()=>at(n,te,X,t,e),[]),W=()=>o?ee(o,g):[e,C(u,g)],$=a.useCallback(s=>{var y;let i=C(s[1]-s[0],g)/(t-e);const l=((y=j.current)==null?void 0:y.clientWidth)||500;return i*l<24?(t-e)/l*24:0},[]),[c,re]=a.useState(()=>W()),[R,O]=a.useState(()=>W()),[K,z]=a.useState(!1),L=a.useRef(null),j=a.useRef(null),v=a.useRef(null),x=a.useRef(null),ne=a.useRef(null),se=a.useRef(null),ae=a.useRef(0),B=Le&&K;a.useEffect(()=>{if(rt(u,o,e,t),!(document.activeElement===v.current||document.activeElement===x.current)){const s=W();re(s),o?O(o):u&&O([0,u]),pe(L,s,j,p,t,e,g),T({values:o,value:u},p,v,x)}},[o,u]),a.useEffect(()=>{T({values:o,value:u},p,v,x)},[v.current,x.current]),a.useEffect(()=>{!K&&w&&w(p?c:c[1])},[K,c]),a.useEffect(()=>{v.current&&v.current.setAttribute("value",c[0]),x.current&&x.current.setAttribute("value",c[1])},[c]);const H=a.useCallback((s,i)=>{const l={left:-1,right:1},m=t*ze,y=c[i]+l[s]*m,k=Q(y,i,p,c,e,t,g,!0);T({values:k,value:y},p,v,x),S(k,i)},[c]),Be=a.useCallback((s,i)=>{["ArrowUp","ArrowDown"].includes(s.key)&&s.preventDefault(),["ArrowLeft","ArrowRight"].includes(s.key)&&(z(!0),s.key==="ArrowLeft"&&H("left",i),s.key==="ArrowRight"&&H("right",i))},[H]),oe=a.useCallback(s=>{if(z(!0),!f&&s.target.nodeName!=="INPUT"){const i=s.touches?st(s):s.nativeEvent.offsetX,l=j.current.clientWidth,m=C(i/l*(t-e)+e,g),y=(c[0]+c[1])/2,k=m>C(y,g)?1:0,J=Q(m,k,p,c,e,t,g);S(J,k),T({values:J,value:J[1]},p,v,x)}},[o,u,c]),S=a.useCallback((s,i,l=!0)=>{if(clearTimeout(ae.current),p){const m=$(s);m>0&&(i==0?s[0]=s[1]-m:s[1]=s[0]+m),T({values:s,value:s[1]},p,v,x)}ae.current=setTimeout(()=>{s=$e(s,e,t),re(s),Y&&l&&O(s),d&&d(p?[Math.round(s[0]),Math.round(s[1])]:Math.round(s[1]))},1),pe(L,s,j,p,t,e,g)},[]),He=a.useCallback((s,i)=>{const l=Q(+s.target.value,i,p,c,e,t,g);S(l,i)},[c]),U=()=>{ue()},ue=()=>{z(!1)},ie=a.useCallback((s,i)=>f?r.jsx("input",{type:"range",disabled:!0,value:c[s],min:e,max:t}):r.jsx("input",{ref:i,type:"range",step:g,min:e,max:t,onKeyDown:l=>Be(l,s),onKeyUp:ue,onChange:l=>He(l,s),...tt({ariaLabel:h,ariaLabelledBy:V,ariaValueText:Ke})}),[c]),le=(s,i)=>{const l=+s.target.value,m=i==0?[l,R[1]]:[R[0],l];O(m);const y=$(m);if(i==0){const k=[l,c[1]];l>=e&&l<=c[1]-y&&S(k,i,!1)}else if(i==1){const k=[c[0],l];l<=t&&l>=c[0]+y&&S(k,i,!1)}},G=a.useMemo(()=>X==="auto"&&typeof g=="number"?(t-e)/g+1:X,[]),Ge=a.useCallback(()=>Array.from(Array(G).keys()).map(s=>{let i="";if(G<15&&(i=(t-e)/(G-1)*s+e,t>100)){const l=t.toString().length-1,m=ut(i/10**l,1);i=m>0?m+"e"+l:0}return r.jsxs("div",{className:"marker",children:[r.jsx("div",{children:"|"}),r.jsx("div",{children:i})]},s)}),[]),[Je,Qe]=B?et(W(),t,e):[0,0],ce=Y?ot(R,e,t,[ne,se],$):[!0,!0];return r.jsxs(r.Fragment,{children:[r.jsx("style",{children:Ze}),r.jsxs("div",{className:"ccSlider.wrapper wrapper",onContextMenu:s=>s.preventDefault(),children:[r.jsxs("div",{className:"active-track",ref:L,children:[r.jsx(me,{display:B&&p,top:document.activeElement===v.current,transform:`translateY(-50px) translateX(calc(-50% + ${Je}px))`,children:c[0]}),r.jsx(me,{display:B,top:document.activeElement===x.current,transform:`translateY(-50px) translateX(calc(50% + ${Qe}px))`,children:c[1]})]}),r.jsxs("div",{className:"input-wrapper",ref:j,onMouseDown:oe,onTouchStart:oe,onKeyUp:U,onMouseUp:U,onTouchEnd:U,onMouseOut:U,children:[p&&ie(0,v),ie(1,x),r.jsx("div",{className:"steps",children:te&&Ge()})]}),Y&&r.jsxs("div",{className:`inputs ${p?"dual":""}`,children:[p&&r.jsx(de,{value:R[0].toString(),ref:ne,invalid:!ce[0],onChange:s=>le(s,0)}),r.jsx(de,{value:R[1].toString(),ref:se,invalid:!ce[1],onChange:s=>le(s,1)})]})]})]})}const et=(e,t,n)=>{const u=-((e[0]-n)/(t-n)-.5)*24,o=-((e[1]-n)/(t-n)-.5)*24;return[u,o]};function tt({ariaLabel:e,ariaLabelledBy:t,ariaValueText:n}){return{"aria-label":e,"aria-labelledby":t,"aria-valuetext":n}}function Z(e,t,n){return Math.min(Math.max(e,t),n)}function rt(e,t,n,u){(e&&e<n||t&&t[0]<n)&&console.warn("Value too low."),(e&&e>u||t&&t[1]>u)&&console.warn("Value too high.")}function T({value:e,values:t},n,u,o){n?(u.current&&(u.current.value=t[0]),o.current&&(o.current.value=t[1])):o.current&&(o.current.value=e)}const Q=(e,t=1,n,u,o,f,d,w=!1)=>{let h;return e=Math.round(e),n?t===1?h=[u[0],e]:h=[e,u[1]]:h=[o,e],w?$e(ee(h,d),o,f):ee(h,d)},nt=(e,t,n,u,o,f)=>{var V;let d=C(e[1]-e[0],f)/(u-o);const w=((V=t.current)==null?void 0:V.clientWidth)||500;(d<0||d>1)&&(console.warn("Values outside of range."),d=Z(d,0,1));const h=n?(e[0]-o)/(u-o)*w:0;return`
    width: ${d*100+"%"};
...
}`,...(Re=(Ce=N.parameters)==null?void 0:Ce.docs)==null?void 0:Re.source}}};var je,Se,Te;M.parameters={...M.parameters,docs:{...(je=M.parameters)==null?void 0:je.docs,source:{originalSource:`() => {
  const [value, setValue] = React.useState(3);
  return <div>
      <output>{value}</output>
...
}`,...(Te=(Se=M.parameters)==null?void 0:Se.docs)==null?void 0:Te.source}}};var Ie,_e,Ae;q.parameters={...q.parameters,docs:{...(Ie=q.parameters)==null?void 0:Ie.docs,source:{originalSource:`() => {
