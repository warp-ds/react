...
describe('Box', () => {
  ...
  test('renders Box component with correct classes when bleed is true', () => {
    ...
    expect(container.firstChild).toHaveClass('group block relative break-words last-child:mb-0 p-16 rounded-8 -mx-16 sm:mx-0 rounded-l-0 rounded-r-0 sm:rounded-8');
  });
  ...
  test('renders Box component with correct classes when clickable and info are true', () => {
    ...
    expect(container.firstChild).toHaveClass('group block relative break-words last-child:mb-0 p-16 rounded-8 s-bg-info-subtle hover:s-bg-info-subtle-hover active:s-bg-info-subtle-active');
  });
  ...
  test('renders Box component with correct classes when clickable and neutral are true', () => {
    ...
    expect(container.firstChild).toHaveClass('group block relative break-words last-child:mb-0 p-16 rounded-8 s-surface-sunken hover:s-bg-hover active:s-bg-active');
  });
  ...
  test('renders Box component with correct classes when clickable and bordered are true', () => {
    ...
    expect(container.firstChild).toHaveClass('group block relative break-words last-child:mb-0 p-16 rounded-8 border-2 s-border s-bg hover:s-bg-hover active:s-bg-active hover:s-border-hover active:s-border-active');
  });
});
