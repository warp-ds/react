...
describe('Box', () => {
  ...
  test('renders Box component with correct classes when info is true', () => {
    ...
    expect(container.firstChild).toHaveClass(
      'group block relative break-words last-child:mb-0 p-16 rounded-8 s-bg-info-subtle',
    );
  });
  ...
  test('renders Box component with correct classes when neutral is true', () => {
    ...
    expect(container.firstChild).toHaveClass(
      'group block relative break-words last-child:mb-0 p-16 rounded-8 s-surface-sunken',
    );
  });
  ...
  test('renders Box component with correct classes when bordered is true', () => {
    ...
    expect(container.firstChild).toHaveClass(
      'group block relative break-words last-child:mb-0 p-16 rounded-8 border-2 s-border s-bg',
    );
  });
});
